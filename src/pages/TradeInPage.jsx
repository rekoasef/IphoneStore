// src/pages/TradeInPage.jsx (actualizado)
import React from 'react';
import StaticPageLayout from '../components/layout/StaticPageLayout';

const TradeInPage = () => {
  const WHATSAPP_NUMBER = "3471592234";
  ...
  return (
    ...
    <ol className="list-decimal list-inside mb-4 space-y-2">
        <li><strong>Contactanos:</strong> Envianos un mensaje por <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer">WhatsApp</a> detallando el modelo exacto de tu dispositivo, su estado general (estético y funcional), porcentaje de salud de batería, y si cuenta con caja y accesorios originales.</li>
    ...
    <p>¡No esperes más para tener lo último de Apple! <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer">Consultanos hoy mismo</a>.</p>
    </StaticPageLayout>
  );
};
